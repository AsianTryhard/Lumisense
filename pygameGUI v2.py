...
pygame.init()
size=(w,h)
myfont = pygame.font.SysFont("myriadwebpro", 25)
...
while True:
    ...
    b1=(70,300+50-75,320,75)
    b2=(70+320+50,300+50-75,320,75)
    b3=(70+320+50+320+50,50,320,125)
    b4=(70+320+50+320+50,50+125+50,320,125)
    b5=(70,50+300+50+450-113-50,1060,80)
    b6=(70+320+50+320+50+300+50,50,50,50)
    button6=pygame.draw.rect(screen, thomasblue,b6)
    if imageChosen==True:
        screen.blit(img0,(int(w/2-sz[0]*.1),int(h/2-sz[1]*.1)))
    path = 'Ham/pics/'
    uploadpic = pygame.image.load(path+'upload.png')
    screen.blit(uploadpic,(70,50))
    previouspic = pygame.image.load(path+'Previous Pics.png')
    screen.blit(previouspic,(70+320+50,50))
    shoppingpic = pygame.image.load(path+'shopping.png')
    screen.blit(shoppingpic,(70,50+300+50))
    exitpic = pygame.image.load(path+'Exit.png')
    screen.blit(exitpic,(70+320+50+320+50+300+50,50))
    
    button1=pygame.draw.rect(screen, thomasblue,b1)
    button2=pygame.draw.rect(screen, thomasblue,b2)
    button3=pygame.draw.rect(screen, thomasblue,b3)
    button4=pygame.draw.rect(screen, thomasblue,b4)
    button5=pygame.draw.rect(screen, thomasblue,b5)
    
    
    
    def words():
        label1 = myfont.render("Upload Image", 1, blueBox)
        screen.blit(label1, (70+25+50+27,300+50-75+25+3))#x+25,y+25 to center in box
        label2 = myfont.render("Calibrate", 1, blueBox)
        screen.blit(label2, (70+320+50+320+50+50+50+27,50+50+3))#x+5,y+15 to center in box
        label3 = myfont.render("Start Shopping", 1, blueBox)
        screen.blit(label3, (70+530-75,50+300+50+450-113+25-50+5))#x+5,y+15 to center in box
        label4 = myfont.render("Previous Photos", 1, blueBox)
        screen.blit(label4, (70+320+25+50+45+27,300+50-75+25+3))#x+5,y+15 to center in box
        label5 = myfont.render("Help", 1, blueBox)
        screen.blit(label5, (70+320+50+320+50+125+20,50+125+50+50+5))#x+5,y+15 to center in box
        
        #label6 = myfont.render("Exit", 1, blueBox)
        #screen.blit(label6, (70+320+50+320+50+300+50+25,50+10))
    words()
        ...
        for event in pygame.event.get():
            if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if button1.collidepoint(mouse_pos):
                        ...
                        pygame.draw.rect(screen, cyan,b1)
                        inp = str(inputbox.ask(screen, 'ImageID',70+50,300+50-75+25))
                        print inp
                        #words()
                    ...
                    if button6.collidepoint(mouse_pos):
                        print('button6 was pressed at {0}'.format(mouse_pos)) #help
                        pygame.quit();
            if event.type == pygame.KEYDOWN: #Press 0key to escape for now
                    if event.key == pygame.K_0:
                        pygame.quit();
    ...
    while gamestate==20:#calibrate with rainbow thingy
        path = sys.path[0]+'/Ham/Calibration.png'
